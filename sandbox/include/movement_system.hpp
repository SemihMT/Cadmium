#ifndef SANDBOX_MOVEMENT_SYSTEM
#define SANDBOX_MOVEMENT_SYSTEM
    ...
    class MovementSystem : public Cadmium::System
    {
      public:
        void OnUpdate(Cadmium::World& world, float dt) override
        {
            ...
            for (auto entity : world.QueryEntities<Cadmium::Transform, Cadmium::Velocity>())
            {
